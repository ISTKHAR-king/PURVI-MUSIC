...
BOT_NAME = getenv("BOT_NAME" , "PIHU")
ASSUSERNAME = getenv("ASSUSERNAME" , "ISTKHAR")
MONGO_DB_URI = getenv("MONGO_DB_URI", None)
DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", 17000))
LOGGER_ID = int(getenv("LOGGER_ID", -1002348470544))
OWNER_ID = int(getenv("OWNER_ID", 7995626429))
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/ISTKHAR-king/PURVI-MUSIC",)
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+eEoTq4PhBLRjZDc1")
